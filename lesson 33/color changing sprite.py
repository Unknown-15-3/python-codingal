...
def main():
    ...
    while not done:
        ...
        elif x == screen_width - sprite_width: current_color = color['red']
        elif y == 0: current_color = color['yellow']
        elif y == screen_height - sprite_height: current_color = color['green']
        else:
