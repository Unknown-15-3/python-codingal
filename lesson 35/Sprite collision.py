...
background_image = pygame.transform.scale(pygame.image.load("lesson 35/bg.jpeg"),(SCREEN_HEIGHT,SCREEN_WIDTH))
...
sprite1 = sprint(pygame.Color("red"),20,30)
...
sprite2 = sprint(pygame.Color("green"), 20, 30)
